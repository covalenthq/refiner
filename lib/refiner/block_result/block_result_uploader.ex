defmodule Refiner.BlockResultUploader do
  require Logger
  ...
  def handle_call(
    ...
    case Refiner.IPFSInteractor.pin(file_path) do
      {:ok, cid} ->
        specimen_hash_bytes32 = Refiner.Util.convert_to_bytes32(block_specimen_hash)
        ...
        case Refiner.ProofChain.Interactor.submit_block_result_proof(
               chain_id,
               block_height,
