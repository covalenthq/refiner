defmodule Refiner.SHA256 do
  ...
  @spec load(any) :: :error | {:ok, %Refiner.SHA256{bytes: binary}}
  @doc false
...
defimpl Jason.Encoder, for: Refiner.SHA256 do
  def encode(%Refiner.SHA256{} = hash, opts) do
    Refiner.SHA256.as_string(hash)
    |> Jason.Encode.string(opts)
  end
end

defimpl String.Chars, for: Refiner.SHA256 do
  def to_string(block_hash), do: Refiner.SHA256.as_string(block_hash)
end

defimpl Inspect, for: Refiner.SHA256 do
  import Inspect.Algebra

  case Mix.env() do
    :prod ->
      def inspect(%Refiner.SHA256{bytes: hash}, opts) do
    ...
    _ ->
      @spec inspect(%Refiner.SHA256{}, Inspect.Opts.t()) ::
              :doc_line
              | :doc_nil
              | binary
