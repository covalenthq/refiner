defmodule Refiner.RPC.JSONRPC.HTTPClient do
  defstruct [:request_uri, :ws_request_uri, :request_headers]
  alias Refiner.RPC.JSONRPC.HTTPAdapter, as: Adapter
  alias Refiner.RPC.JSONRPC.WSAdapter, as: LongCallAdapter

  @spec get_or_create(any, binary | URI.t()) :: %Refiner.RPC.JSONRPC.HTTPClient{
  ...
  defimpl Refiner.RPC.JSONRPC.Client do
    @spec call(%Refiner.RPC.JSONRPC.HTTPClient{}, any, any, any) :: none
    ...
    @spec long_call(%Refiner.RPC.JSONRPC.HTTPClient{}, any, any) :: none
    ...
    @spec delete(%Refiner.RPC.JSONRPC.HTTPClient{}, binary | URI.t()) ::
