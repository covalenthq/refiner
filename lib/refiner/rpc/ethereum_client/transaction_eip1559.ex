defmodule Refiner.RPC.EthereumClient.TransactionEIP1559 do
  alias Refiner.Wallet
  ...
  def normalize_address(%Wallet{address: %Refiner.RPC.PublicKeyHash{} = pkh}), do: pkh
  def normalize_address(other), do: Refiner.RPC.PublicKeyHash.parse_raw!(normalize_bin(other))

  defp term_to_rlpable(nil), do: ""
  defp term_to_rlpable(0), do: 0
  defp term_to_rlpable(%Refiner.RPC.PublicKeyHash{bytes: bin}), do: bin
