defmodule Rudder.DecodeBlockSpecimenTest do
  ...
  test "Rudder.Avro.DecodeBlockSpecimen.list/0 returns an empty list", %{
    decodeBlockSpecimen: _decodeBlockSpecimen
  } do
    assert Rudder.Avro.DecodeBlockSpecimen.list() == []
  end

  test "Rudder.Avro.DecodeBlockSpecimen.get_schema/0 returns correct schema", %{
    decodeBlockSpecimen: _decodeBlockSpecimen
  } do
    assert Rudder.Avro.DecodeBlockSpecimen.get_schema() ==
             "com.covalenthq.brp.avro.ReplicationSegment"
  end

  test "Rudder.Avro.DecodeBlockSpecimen.decode_file/1 decodes binary specimen file", %{
    decodeBlockSpecimen: _decodeBlockSpecimen
  } do
    specimen_path =
